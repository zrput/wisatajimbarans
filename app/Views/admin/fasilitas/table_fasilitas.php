            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <button type="button" class="btn btn-primary mt-3" onclick="location.href='<?= base_url('Fasilitas/form_fasilitas')?>'"><i class="ti-plus btn-icon-append"></i> Tambah Data</button>
                      ...
                      <tbody>
                        ...
                        <?php foreach ($data as $datas) : ?>
                          <tr>
                            ...
                            <td>
                            <button type="button" class="btn btn-info py-3" onclick="location.href='<?= base_url('Fasilitas/edit_fasilitas'). '/' . $datas->id_fasilitas?>'"><i class="ti-file btn-icon-append"></i>Edit</button>
                            <button type="button" class="btn btn-danger py-3" onclick="location.href='<?= base_url('Fasilitas/delete_fasilitas'). '/' . $datas->id_fasilitas?>'"><i class="ti-trash btn-icon-append"></i>Delete</button>
                            </td>
                          </tr>
                          <?php $no++; ?>
                        <?php endforeach; ?>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    data.forEach(function (imagePath) {
                            ...
                            var img = $('<img>').attr('src', '../../fasilitas_penginapan/'+imagePath.gambar_fasilitas).addClass('img-thumbnail')
