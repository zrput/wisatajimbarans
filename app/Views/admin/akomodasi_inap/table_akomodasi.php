                      ...
                      <tbody>
                        ...
                        <?php foreach ($data as $datas) : ?>
                          <tr>
                            ...
                            <td>
                            <button type="button" class="btn btn-info py-3" onclick="location.href='<?= base_url('Akomodasi/edit_akomodasi'). '/' . $datas->id_penginapan?>'"><i class="ti-file btn-icon-append"></i>Edit</button>
